...
|---|---|---|
| [SPEC.md](SPEC.md) | Spécification technique globale du projet | 2026-06-13 (PR #219) |
...
| PR | Titre | Date |
|---|---|---|
| [#219](pr-219-consolidation-auto.md) | [CONSOLIDATION] Refonte architecture multi-module : runner.py + core + storage + models | 2026-06-13 |
